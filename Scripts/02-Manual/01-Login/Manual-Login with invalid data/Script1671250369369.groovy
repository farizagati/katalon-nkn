...
WebUI.setText(findTestObject('02-Obj Manual/02-Login Page/txtField_username'), 'Mas Bambang')
...
WebUI.verifyElementPresent(findTestObject('02-Obj Manual/02-Login Page/txt_Login failed'), 0)
