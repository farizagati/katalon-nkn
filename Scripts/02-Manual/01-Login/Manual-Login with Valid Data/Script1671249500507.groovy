...
WebUI.verifyElementNotPresent(findTestObject('02-Obj Manual/01-Homepage/btn_menu_Login'), 0)

WebUI.click(findTestObject('02-Obj Manual/01-Homepage/btn_menu_Logout'))

WebUI.waitForElementPresent(findTestObject('02-Obj Manual/01-Homepage/txt_h1_CURA Healthcare Service'), 0)

WebUI.click(findTestObject('02-Obj Manual/01-Homepage/btn_menu-toggle'))

WebUI.verifyElementPresent(findTestObject('02-Obj Manual/01-Homepage/btn_menu_Login'), 0)
